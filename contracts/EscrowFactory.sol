...
contract EscrowFactory {
     ...
     * @param _amount The amount of tokens for the escrow.
    ...
    function createEscrow(
        ...
        Escrow newEscrow = new Escrow(buyer, _seller, _arbiter, _token, _amount);
        ...
        emit EscrowCreated(newEscrowAddress, buyer, _seller, _arbiter, _token, _amount);
